                                        ...
                                        <div className="application-form-div mb-4">
                                            <div className="form-md m-0">
                                                ...
                                                <div className="form-group form-buttns-div">
                                                    {/* <button className="btn btn-prevw"><i className="bi bi-pencil-square"></i> Review/Edit</button> */}
                                                    <button className="btn btn-login" onClick={() => { props.updateCompanyFun() }}> Update</button>
                                                </div>
                                            </div>
                                        </div>
