            ...
            <nav id="sidebar" className="sidebar-wrapper">
                <div className="sidebar-content">
                    <div className="sidebar-brand">
                        <a><img src="assets/img/signdocx-logo.svg" /></a>
                    ...
                    <div className="sidebar-menu">
                        <ul>
                            ...
                            {/* <li className="nav-item">
                                    <a><i className="bi bi-life-preserver"></i>Inventory</a>
                                </li>
                                <li className="nav-item">
                                    <a><i className="bi bi-life-preserver"></i>Application List</a>
                                </li>
                                <li className="nav-item">
                                    <a><i className="bi bi-life-preserver"></i>Pending</a>
                                </li>
                                <li className="nav-item">
                                    <a><i className="bi bi-life-preserver"></i>Approved</a>
                                </li>
                                <li className="nav-item">
                                    <a><i className="bi bi-life-preserver"></i>e-Sign</a>
                                </li>
                                <li className="nav-item">
                                    <a><i className="bi bi-life-preserver"></i>e-Stamp</a>
                                </li>
                                <li className="nav-item">
                                    <a><i className="bi bi-life-preserver"></i>e-Mandate</a>
                                </li> */}
